...
We collected data from `r e1_actual_participants$PROLIFIC_PID %>% unique %>% length` participants aged from `r participant_ages %>% min` to `r participant_ages %>% max` (mean age: `r participant_ages %>% mean %>% round(2)`) recruited through Prolific [www.prolific.co, -@prolific2021]. Of the participants, `r male_participants_nr` identified as male, `r female_participants_nr` identified as female, `r other_participants_nr` identified as other, and `r NA_participants_nr` declined to identify their gender. The experiment was only shown to participants who indicated that English was their first language in the Prolific screening questions. Based on Participants who completed the experiment were paid £1.25 for their participation (corresponding to £5/hour). All participants were naïve to the purpose of the experiment.
