...
This study was pre-registered on the Open Science Framework (OSF) prior to data collection. The registration form for Experiment 1, together with the materials, data files, and R scripts can be found at {[}\url{https://osf.io/57rzq/}{]}. The registration form for Experiment 2 can be found at {[}\url{https://osf.io/957s8}{]}.
...
\begin{figure}
\centering
\includegraphics{MaskedPriming_complete_mspg_files/figure-latex/hyp-mod-dat-figure-1.pdf}
...
\begin{figure}
\centering
\includegraphics{MaskedPriming_complete_mspg_files/figure-latex/deltas-e1-words-1.pdf}
...
\begin{figure}
\centering
\includegraphics{MaskedPriming_complete_mspg_files/figure-latex/deltas-e2-words-1.pdf}
