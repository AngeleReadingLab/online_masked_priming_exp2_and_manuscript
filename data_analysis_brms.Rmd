...
lmm_exp1 <- lmer(data = exp1_data_to_include %>% filter(corr == 1 & StimulusType == "WORD" & rt < 1500), rt ~ Condition * PrimeDuration + (1|source) + (1|Target))
...
lmm_exp2 <- lmer(data = exp2_data_to_include %>% filter(corr == 1 & StimulusType == "WORD" & rt < 1500), rt ~ Condition * PrimeDuration + (1|source) + (1|Target))
...
blmm_exp1 <- brm(data = exp1_data_to_include %>% filter(corr == 1 & StimulusType == "WORD" & rt < 1500, rt ~
Condition * PrimeDuration + (1 + Condition * PrimeDuration|source) + (1 + Condition * PrimeDuration|Target),
warmup = 1000,
iter = 5000,
chains = 4,
prior = prior_exp1,
...
save(blmm_exp1, file = "blmm_exp1.RData")
```
