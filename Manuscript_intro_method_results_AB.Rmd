...
To better visualize the data, we computed the delta plots for the effect of Priming (see Panel A in
Figure \@ref(fig:Deltas_E1_Words) ), as well as for the effect of Prime Duration (see Panel B in Figure \@ref(fig:Deltas_E1_Words) ). These delta plots are residual quantile plots that show the size of the effect for the .1, .3, .5, .7, and .9 response time quantiles.


```{r Deltas_E1_Words, echo=FALSE, cache=TRUE, fig.cap = "Delta in Experiment 1...EXPLAIN.", message=FALSE, warning=FALSE}
...
We also created the delta plots for the effect of Priming (see Panel A in Figure \@ref(fig:Deltas_E2_Words)), as well as for the effect of Prime Duration (see Panel B in Figure \@ref(fig:Deltas_E2_Words)).

(ref:Deltas_E2_Words-caption) Delta in Experiment 2...EXPLAIN.

```{r Deltas_E2_Words, echo=FALSE, cache=TRUE, fig.cap = "(ref:exp1-brms-rt-plot-caption)"}
