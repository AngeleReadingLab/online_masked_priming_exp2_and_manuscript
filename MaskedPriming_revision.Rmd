...
authornote: |
  ...
  This study was pre-registered on the Open Science Framework (OSF) prior to data collection. The registration form for Experiment 1, together with the materials, data files, and R scripts can be found at [https://osf.io/57rzq/]. The registration form for Experiment 2 can be found at [https://osf.io/957s8].
abstract: |
